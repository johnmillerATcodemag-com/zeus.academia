        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefreshTokens_Dates", "ExpiresAt > CreatedAt");
                    table.CheckConstraint("CK_RefreshTokens_Revocation", "(IsRevoked = 0 AND RevokedAt IS NULL) OR (IsRevoked = 1 AND RevokedAt IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_User_Status_Expiry",
                table: "RefreshTokens",
